  ...
  return (
    <footer className="bg-[var(--forest)] text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          <h4 className="font-semibold mb-4 text-[var(--amber)] text-sm uppercase tracking-wider">Навигация</h4>
        ...
        <div>
          <h4 className="font-semibold mb-4 text-[var(--amber)] text-sm uppercase tracking-wider">Контакты</h4>
